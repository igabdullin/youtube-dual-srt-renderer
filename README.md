...
2. Для перевода нажмите кнопку **RU** и выберите SRT‑файл с переводом
3. Для оригинала нажмите кнопку **EN** и выберите SRT‑файл с оригинальными субтитрами
4. После успешной загрузки соответствующая иконка подсветится синим цветом
5. Во время воспроизведения:
   - текущий субтитр подсвечивается
   - сверху/снизу могут отображаться соседние фразы, попадающие в окно времени
